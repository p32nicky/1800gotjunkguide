...
export const metadata: Metadata = {
  title: { default: "Junk Removal Guide — Reviews, Pricing & Tips", template: "%s | Junk Removal Guide" },
  description: "The #1 resource for junk removal — honest reviews, pricing guides, comparisons, and tips for 1-800-GOT-JUNK? and other services.",
  metadataBase: new URL(SITE_URL),
  openGraph: { siteName: "Junk Removal Guide", type: "website", locale: "en_US" },
      ...
      <body className="min-h-screen bg-white text-gray-900 antialiased">
        <header className="border-b border-gray-100 bg-white sticky top-0 z-10">
          <div className="max-w-5xl mx-auto px-4 py-3 flex items-center justify-between">
            <a href="/" className="font-bold text-lg text-green-600 hover:text-green-700">
              🗑️ Junk Removal Guide
            </a>
